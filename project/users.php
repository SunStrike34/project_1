...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link">
        ...
        <main id="js-page-content" role="main" class="page-content mt-3">
            ...
            <?php }?>
            <?php if (isset($_SESSION['successAddUser'])) {?>
                <div class="alert alert-success">
                    Профиль успешно создан.
                    <?php unset($_SESSION['successAddUser'])?>
                </div>
            <?php } ?>
            <div class="subheader">
                        ...
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status status-<?=$user['status']?> mr-3">
                                    <a href='/project/page_profile.php?id=<?=$user['id']?>'>
                                    <span class="rounded-circle profile-image d-block " style="background-image:url('<?=(!is_null($user['image']))?$user['href'].$user['name'].'.'.$user['format']: '/project/upload/defoltImage.jpg'?>'); background-size: cover;"></span>
                                    </a>
                                </span>
                                <div class="info-card-text flex-1">
                                    <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                        <?=$user['username']?>
                                        <?php if ($_SESSION['role'] == true || $_SESSION['id'] == $user['id']) { ?>
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        <a href="?delete=yes&id=<?=$user['id']?>" class="dropdown-item" onclick="return confirm('are you sure?');">
